                    ...
                    <div class="box box-dashboard">
                        <div class="box-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('administration.courses.create') }}" class="btn btn-primary pull-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="control-td">
                                            ...
                                            <table class="table-app no-margin pull-right">
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('administration.courses.edit',['id' => $course->id ]) }}" class="btn btn-warning pull-left">
                                                            <i class="fa fa-edit"></i>
                                                            Editar
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <form method="post" action="{{route('administration.courses.destroy', ['id'=> $course->id])}}">
                                                            @csrf
                                                            @method('delete')
